...
The ability of functions to be used as values, and that to be passed as arguements or can be returned from another function, this ability is only known as First Class Function
