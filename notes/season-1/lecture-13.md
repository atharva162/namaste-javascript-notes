...
The ability of functions to be used as values like they can be assigned to a variable, or can be passed as arguments or can be returned from another function, this ability is only known as First Class Function
